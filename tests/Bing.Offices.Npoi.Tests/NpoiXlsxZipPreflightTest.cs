...
public sealed class NpoiXlsxZipPreflightTest
{
    ...
    /// </summary>
    /// <param name="entryName">要构造的 XML 部件名称。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="entryName">要超过专项预算的 XML 部件名称。</param>
    /// <param name="expectedName">预期异常中显示的部件名称。</param>
    [Theory]
    ...
    /// 创建 ZIP 文件。
    /// </summary>
    /// <param name="entries">ZIP 条目集合。</param>
