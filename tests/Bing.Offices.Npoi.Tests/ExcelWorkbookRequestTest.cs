...
public sealed class ExcelWorkbookRequestTest
{
    ...
    /// </summary>
    /// <param name="failurePoint">注入关系委托异常的位置。</param>
    [Theory]
    [InlineData("parents")]
    [InlineData("children")]
    ...
    /// </summary>
    /// <param name="format">要测试的 Excel 文件格式。</param>
    /// <param name="resetFirst">是否在保留样式前先执行 reset。</param>
    [Theory]
    ...
    /// <returns>生成的 ExcelMappingDocument 结果。</returns>
    ...
    /// <param name="resourceLimits">资源限制。</param>
    /// <returns>生成的 ExcelWorkbookImportResult&lt;DynamicTargetWorkbook&gt; 结果。</returns>
    ...
    /// <returns>生成的 CsvImportResult&lt;DynamicTargetRow&gt; 结果。</returns>
    ...
    /// <returns>生成的 MetadataSnapshot 结果。</returns>
    ...
    /// </summary>
    /// <param name="workbook">工作簿对象。</param>
    /// <returns>生成的 ICellStyle 结果。</returns>
    ...
    {
        /// <summary>
        /// 初始化一个 <see cref="MetadataSnapshot" /> 类型的实例。
        /// </summary>
        /// <param name="expected">预期元数据快照名称。</param>
        /// <param name="author">预期作者。</param>
        /// <param name="company">预期公司。</param>
        /// <param name="title">预期标题。</param>
        /// <param name="subject">预期主题。</param>
        /// <param name="category">预期类别。</param>
        /// <param name="description">预期描述。</param>
    ...
    /// <param name="failurePoint">失败点。</param>
    /// <returns>生成的集合。</returns>
