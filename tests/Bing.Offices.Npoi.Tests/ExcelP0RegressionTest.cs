...
public sealed class ExcelP0RegressionTest
{
    ...
    /// </summary>
    /// <param name="mode">要测试的导入校验模式。</param>
    /// <param name="configuredErrorCount">配置规则预期产生的错误数。</param>
    /// <param name="workbookErrorCount">工作簿规则预期产生的错误数。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="validationMode">要测试的工作簿校验模式。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="emptyCellAllowed">是否允许校验单元格为空。</param>
    ...
    /// </summary>
    /// <param name="operation">要测试的比较操作编号。</param>
    /// <param name="first">第一个操作数文本。</param>
    /// <param name="second">第二个操作数文本，可为空。</param>
    /// <param name="value">待校验值文本。</param>
    /// <param name="expectedValid">校验结果是否应为有效。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="operation">要测试的比较操作。</param>
    /// <param name="first">第一个 Decimal 操作数文本。</param>
    /// <param name="second">第二个 Decimal 操作数文本，可为空。</param>
    /// <param name="value">待校验 Decimal 值文本。</param>
    /// <param name="expectedValid">校验结果是否应为有效。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="validationType">要测试的值类型。</param>
    /// <param name="operation">要测试的比较操作。</param>
    /// <param name="first">第一个边界文本。</param>
    /// <param name="second">第二个边界文本，可为空。</param>
    /// <param name="value">待校验值文本。</param>
    /// <param name="expectedValid">校验结果是否应为有效。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="policy">要测试的批注冲突策略。</param>
    /// <param name="expectedText">预期保留或写入的批注文本。</param>
    /// <param name="expectedAuthor">预期保留或写入的批注作者。</param>
    /// <param name="shouldThrow">是否预期因冲突抛出异常。</param>
    [Theory]
    ...
    /// </summary>
    /// <param name="legacyFormat">是否使用 XLS 格式。</param>
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    ...
    /// </summary>
    /// <param name="outOfMemory">是否注入内存不足异常，否则注入取消异常。</param>
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    ...
    /// 创建 XML 预算探针工作簿。
    /// </summary>
    /// <param name="workbookXml">工作簿对象。</param>
    /// <returns>生成的字节内容。</returns>
    ...
    /// 运行资源探针并收集结果。
    /// </summary>
    /// <param name="inputPath">目标文件或目录路径。</param>
    /// <param name="mode">处理模式。</param>
    /// <returns>生成的 ProbeOutput 结果。</returns>
    ...
    /// <param name="uniqueStrings">唯一字符串集合。</param>
    /// <param name="styles">样式集合。</param>
    /// <param name="pictures">图片数据或图片对象。</param>
    /// <returns>生成的字节内容。</returns>
    ...
    {
        /// <summary>
        /// 初始化一个 <see cref="ProbeOutput" /> 类型的实例。
        /// </summary>
        /// <param name="mode">探测模式。</param>
        /// <param name="status">探测状态。</param>
        /// <param name="rejectStage">输入被拒绝的阶段。</param>
        /// <param name="inputBytes">输入字节数。</param>
        /// <param name="sheets">工作表数量。</param>
        /// <param name="rows">数据行数。</param>
        /// <param name="columns">数据列数。</param>
        /// <param name="cells">单元格数量。</param>
        /// <param name="importedRows">导入行数。</param>
        ...
        /// <param name="peakWorkingSet">工作集峰值（字节）。</param>
        /// <param name="exitCode">进程退出代码。</param>
        /// <param name="inputSha256">输入内容的 SHA-256 哈希。</param>
    ...
    /// </summary>
    /// <param name="format">目标文件格式。</param>
    /// <param name="validationType">校验类型。</param>
    /// <param name="operation">待执行的操作。</param>
    /// <param name="first">第一个数据项。</param>
    /// <param name="second">第二个数据项。</param>
    /// <param name="value">待处理的值。</param>
    ...
    /// 创建包含富文本失败数据的工作簿。
    /// </summary>
    /// <param name="legacyFormat">旧格式选项。</param>
    /// <returns>生成的字节内容。</returns>
    ...
    /// <param name="run">执行回调。</param>
    /// <returns>生成的 IFont 结果。</returns>
    ...
    /// <param name="pictureBytes">待处理的字节内容。</param>
    /// <param name="header">表头内容。</param>
    ...
    {
        /// <summary>
        /// 初始化一个 <see cref="ThrowingDestinationStream" /> 类型的实例。
        /// </summary>
        /// <param name="buffer">作为初始内容的字节缓冲区。</param>
    ...
    private sealed class ExceptionWriteFileSystem : IFailureWorkbookFileSystem
    {
        ...
        /// <summary>
        /// 初始化一个 <see cref="ExceptionWriteFileSystem" /> 类型的实例。
        /// </summary>
        /// <param name="exception">写入操作应传播的异常。</param>
    ...
    private sealed class ExceptionWriteStream : MemoryStream
    {
        ...
        /// <summary>
        /// 初始化一个 <see cref="ExceptionWriteStream" /> 类型的实例。
        /// </summary>
        /// <param name="exception">写入操作应抛出的异常。</param>
    ...
    private sealed class CancelOnWriteStream : MemoryStream
    {
        ...
        /// </summary>
        /// <param name="cancellation">写入后用于触发取消的令牌源。</param>
