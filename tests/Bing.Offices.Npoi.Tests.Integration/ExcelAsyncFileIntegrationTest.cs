...
public sealed class ExcelAsyncFileIntegrationTest
{
    ...
    /// <returns>生成的 (IExcelExporter Exporter, IExcelImporter Importer) 结果。</returns>
    ...
    /// 创建 Excel 导入请求。
    /// </summary>
    /// <returns>生成的 ExcelWorkbookImportRequest&lt;AsyncFileWorkbook&lt;AsyncFileRow&gt;&gt; 结果。</returns>
    ...
    /// </summary>
    /// <param name="format">目标文件格式。</param>
    /// <param name="sheetName">工作表对象。</param>
    /// <returns>生成的字节内容。</returns>
