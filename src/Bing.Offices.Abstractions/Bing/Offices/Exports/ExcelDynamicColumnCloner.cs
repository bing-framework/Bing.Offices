...
/// <summary>复制并合并请求级动态列定义的内部辅助类。</summary>
internal static class ExcelDynamicColumnCloner
{
    /// <summary>复制动态列定义集合。</summary>
    ...
    /// <summary>将请求级动态列定义合并到映射配置。</summary>
    ...
    /// <summary>将列位置转换为稳定的相对布局键。</summary>
    ...
    /// <summary>将 CLR 类型转换为动态列允许的数据类型名称。</summary>
