...
{
    /// <summary>
    /// 获取或初始化输入流最大字节数，默认 128 MiB；显式设置 null 可关闭该限制。
    /// </summary>
    public long? MaxInputBytes { get; init; } = 128L * 1024 * 1024;

    /// <summary>
    /// 获取或初始化最大数据行数；null 表示不额外限制。
    /// </summary>
