...
/// <summary>
/// 保存 NPOI 导入过程的实体类型执行选项。
/// </summary>
/// <remarks>
/// 仅供内部执行流程使用，不作为公开兼容 API。
/// </remarks>
