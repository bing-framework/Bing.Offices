...
{
    /// <summary>获取或设置合并区域索引；未对应已登记的合并区域时可为 -1。</summary>
    public int Index { get; set; }

    /// <summary>获取或设置左上角的零基行号（含）。</summary>
    public int FirstRow { get; set; }

    /// <summary>获取或设置右下角的零基行号（含）。</summary>
    public int LastRow { get; set; }

    /// <summary>获取或设置左上角的零基列号（含）。</summary>
    public int FirstCol { get; set; }

    /// <summary>获取或设置右下角的零基列号（含）。</summary>
    public int LastCol { get; set; }

    /// <summary>初始化一个 <see cref="MergedRegionInfo" /> 类型的实例。</summary>
