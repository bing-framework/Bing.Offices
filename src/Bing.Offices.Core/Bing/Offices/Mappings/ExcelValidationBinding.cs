...
internal sealed class ExcelValidationBinding : IExcelValidationBinding
{
    ...
    /// <summary>创建由属性特性和对应规则组成的校验绑定。</summary>
    /// <param name="attribute">声明校验配置的属性特性。</param>
    ...
    /// <summary>创建由命名规则组成的校验绑定。</summary>
    ...
    /// <summary>获取绑定规则的标准类型。</summary>
    public ExcelValidationBindingKind Kind { get; }
    /// <summary>获取是否在值转换前使用原始单元格值校验。</summary>
    public bool IsRaw { get; }
    /// <summary>获取校验失败时使用的错误消息。</summary>
    ...
    /// <summary>将校验特性映射为统一的绑定类型。</summary>
